...
// APCS
// HW35 -- A Pirate's Life for Me, Updated
// 2021-11-15

/*
DISCO
- When dealing with linear processes, it is best to use iteration to interact and process data.

QCC
- In what cases would recursion be better suited to dealing with processing data? What types of data are best suited for recursion?
- Linear search implies there are more ways of searching. Which way is most efficient in this scenario?
*/
